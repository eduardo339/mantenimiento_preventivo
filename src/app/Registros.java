...
public class Registros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(830, 623));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(fec_compra, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(fecha_mantenimiento, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(90, 90, 90)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(fec_man_prox, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(fec_man_prox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addComponent(jLabel17)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(guardar, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if (!codInventario.getText().equals("") && !nuevoCodInventario.getText().equals("")) {

            int flag = JOptionPane.showConfirmDialog(null, "¿Estás seguro(a) de guardar este registro?");
            if (flag == 0) {
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement(
                            """
            INSERT INTO dbo.prog_mant_prev
            (codigo_inventario
            ,nuevo_cod_inv
            ,unidad_negocio
            ,tipo_equipo
            ...
            JOptionPane.showMessageDialog(null, "Necesita llenar al menos los dos primeros campos");
        }

    }//GEN-LAST:event_guardarActionPerformed

    private void limpiar() {
        codInventario.setText("");
        nuevoCodInventario.setText("");
        unidadNegocio.setSelectedIndex(0);
        tipoEquipo.setSelectedIndex(0);
        marca.setText("");
        modelo.setText("");
        numSerie.setText("");
        caracteristicas.setText("");
        estatusFuncionamiento.setSelectedIndex(0);
        usuarioAsignado.setText("");
        area.setSelectedIndex(0);
        ubicacion.setSelectedIndex(0);
        estMantenimiento.setSelectedIndex(0);
        tiempoMTTO.setSelectedIndex(0);
        fecha_mantenimiento.setDate(null);
        fecha_mantenimiento.setDate(null);
        obsCom.setText("");
        fecha_mantenimiento.setDate(null);
        porcentajeDevaluacion.setText("");
        estatus.setText("");
    }
    ...
    private org.jdesktop.swingx.JXDatePicker fec_compra;
    private org.jdesktop.swingx.JXDatePicker fec_man_prox;
    private org.jdesktop.swingx.JXDatePicker fecha_mantenimiento;
