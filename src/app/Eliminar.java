...
public class Eliminar extends javax.swing.JFrame {
    ...
    protected String elArea[] = {"Seleccione una opción", "SISTEMAS", "COMPRAS", "VENTAS FACT", "PRODUCCIÓN", "MARKETING", "FINANZAS", "RH", "ALMACÉN MP", "LABORATORIO", "CALIDAD", "PRODUCCIÓN", "SGC", "RECEPCIÓN", "SERVICIO TÉCNICO", "OPERACIONES", "ALMACÉN", "SERVICIO MÉDICO", "VTAS. TABASCO", "VTAS. AXP. TABASCO", "VENDEDOR", "RRHH", "DIR. OPERACIONES", "SERVICIO AL CLIENTE", "ALM HERMOSILLO", "CEDIS", "ALMACÉN PT", "POR DEFINIR"};
    protected String elUbicacion[] = {"Seleccione una opción", "Seleccione una opción", "PLANTA QRO", "CIVAC", "CHIHUAHUA", "MERIDA", "HERMOSILLO", "CDMX", "GUADALAJARA", "COLIMA", "CULIACÁN", "TABASCO", "LEON GTO.", "PLANTA ART", "ARTLUX", "MORELIA", "OAXACA", "CEDIS QRO", "PANTA TOFF QRO"};
    ...
    private void initComponents() {
        ...
        fecha_compra = new org.jdesktop.swingx.JXDatePicker();
        ...
        codInventario.setFocusable(false);
        codInventario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                codInventarioActionPerformed(evt);
            }
        });

        unidadNegocio.setModel(new javax.swing.DefaultComboBoxModel<>(elUnidadNegocio));
        unidadNegocio.setEnabled(false);
        unidadNegocio.setFocusable(false);
        unidadNegocio.setLightWeightPopupEnabled(false);
        unidadNegocio.setRequestFocusEnabled(false);
        unidadNegocio.setVerifyInputWhenFocusTarget(false);
        ...
        tipoEquipo.setFocusable(false);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Nuevo Código de Inventario");

        nuevoCodInventario.setFocusable(false);
        nuevoCodInventario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nuevoCodInventarioActionPerformed(evt);
            }
        });
        ...
        estatusFuncionamiento.setEnabled(false);
        estatusFuncionamiento.setFocusable(false);

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Usuario asignado");

        usuarioAsignado.setFocusable(false);
        usuarioAsignado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                usuarioAsignadoActionPerformed(evt);
            }
        });
        ...
        estMantenimiento.setEnabled(false);
        estMantenimiento.setFocusable(false);
        ...
        tiempoMTTO.setEnabled(false);
        tiempoMTTO.setFocusable(false);
        ...
        porcentajeDevaluacion.setFocusable(false);
        porcentajeDevaluacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                porcentajeDevaluacionActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(fecha_compra, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(35, 35, 35)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void codInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_codInventarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_codInventarioActionPerformed

    private void nuevoCodInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoCodInventarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nuevoCodInventarioActionPerformed
    ...
    private void usuarioAsignadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_usuarioAsignadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_usuarioAsignadoActionPerformed

    private void porcentajeDevaluacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_porcentajeDevaluacionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_porcentajeDevaluacionActionPerformed
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        String S_FechaCompra = parseDate(fecha_compra.getDate());
        String S_Devaluación = porcentajeDevaluacion.getText().toUpperCase();
        String S_Estatus = estatus.getText().toUpperCase();

        int opt = JOptionPane.showConfirmDialog(null, "¿Está seguro(a) que desea DAR DE BAJA este registro?");
        if (opt == 0) {
            try {
                ...
                PreparedStatement ps = con.prepareStatement(
                        """
                INSERT INTO dbo.man_prev_bajas
                (codigo_inventario
                ,nuevo_cod_inv
                ,unidad_negocio
                ,tipo_equipo
                ...
                ps.setString(2, S_NuevoCodInv);
                ps.setString(3, S_UnidadNegocio);
                ps.setString(4, S_TipoEquipo);
                ps.setString(5, S_Marca);
                ps.setString(6, S_Modelo);
                ps.setString(7, S_NumSerie);
                ps.setString(8, S_Caracteristicas);
                ps.setString(9, S_Estatus_func);
                ps.setString(10, S_UsuarioAsignado);
                ps.setString(11, S_Area);
                ps.setString(12, S_Ubicacion);
                ps.setString(13, S_Estatus_man);
                ps.setString(14, S_TiempoMTTO);
                ps.setString(15, S_FecMantenimiento);
                ps.setString(16, S_FecMantProx);
                ps.setString(17, S_ObsCom);
                ps.setString(18, S_FechaCompra);
                ps.setString(19, S_Devaluación);
                ps.setString(20, S_Estatus);
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement(
                        """
                    DELETE FROM dbo.prog_mant_prev
                ...
                ps.executeUpdate();
                JOptionPane.showMessageDialog(null, "El registro se a dado de Baja");
    ...
    protected org.jdesktop.swingx.JXDatePicker fecha_compra;
